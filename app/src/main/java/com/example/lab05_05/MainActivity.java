...
public class MainActivity extends AppCompatActivity {
    ...
    private String audioUrl = "https://tuemanchau309.github.io/NT118-Mobile/hihi.mp3";
    ...
    private class PlayTask extends AsyncTask<String, Void, Boolean> {
        ...
        @Override
        //hiển thị hộp thoại tiến trình để thông báo cho người dùng rằng âm thanh đang được tải xuống
        ...
        @Override
        //Sau khi hoàn thành tác vụ nền, ẩn hộp thoại tiến trình. Nếu thành công, bắt đầu phát âm thanh. Nếu thất bại, hiển thị thông báo lỗi.
